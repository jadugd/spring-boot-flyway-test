...
import com.springboot.test.repository.CommentRepository;
...
public class CommentController {
	...
	public Page<CommentModel> getAllCommentByPostId(@PathVariable (value="postId") Long postId, Pageable pageable) {
		return commentRepository.findByPostId(postId, pageable);
	}
	
	@PostMapping("/posts/{postId}/comments")
	public CommentModel createComment(@PathVariable (value="postId") Long postId, @Valid @RequestBody CommentModel comment) {
